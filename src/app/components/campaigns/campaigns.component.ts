...
export class CampaignsComponent implements OnInit {
  ...
  edit(data: any) {
    this.modeOpen = false;
    this.modeEdit = true;
    let created = data ? data.campaign ? moment(data.campaign.createdAt).format("YYYY-MM-DDTkk:mm") : "" : "";
    let update = data ? data.campaign ? moment(data.campaign.updatedAt).format("YYYY-MM-DDTkk:mm") : "" : "";
    data.campaign.createdAt = created;
    data.campaign.updatedAt = update;
